            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-surface-elevated rounded-2xl flex items-center justify-center text-primary mb-6 shadow-inner border border-border-subtle group-hover:shadow-[0_0_20px_rgba(var(--primary),0.2)] transition-shadow">
